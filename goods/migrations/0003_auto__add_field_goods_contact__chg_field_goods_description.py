...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'goods.contact'
        db.add_column(u'goods_goods', 'contact',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)


        # Changing field 'goods.description'
        db.alter_column(u'goods_goods', 'description', self.gf('django.db.models.fields.TextField')(max_length=10000))

    def backwards(self, orm):
        # Deleting field 'goods.contact'
        db.delete_column(u'goods_goods', 'contact')


        # Changing field 'goods.description'
        db.alter_column(u'goods_goods', 'description', self.gf('django.db.models.fields.CharField')(max_length=10000))
    ...
    models = {
        ...
        u'goods.goods': {
            ...
            'goods_cover': ('django.db.models.fields.files.ImageField', [], {'default': "'Image/defaultPhotoNotFound'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
